...
abstract class tour implements Tour {
...
class tournuocngoai extends tour{
    ...
    @Override
    public void xuat(){
        super.xuat(); // Xuất thông tin cơ bản của tour
        System.out.printf("%-15s %-15s\n", quocgia, ngoaite); // Xuất thông tin riêng của tour nước ngoài
    }
}
class tourtrongnuoc extends tour{
    ...
    public void xuat(){
        super.xuat(); // Xuất thông tin cơ bản của tour
        System.out.printf("%-15s %-15s\n", tinhthanh, dacsan); // Xuất thông tin riêng của tour trong nước
    }
}